...
export function createTimeline(jsPsych) {
  ...
  var instructions = {
    ...
    stimulus: function () {
      ...
      if (expOptions.comprehension) {
        return (
          standard_instructions +
          comprehension_instructions +
          "<p>Press the spacebar to continue to the experiment.</p>"
        );
      } else {
  ...
  var feedback = {
    ...
    conditional_function: function () {
      return expOptions.correctiveFeedback;
    },
  };
  ...
  var comprehension_questions = {
    timeline: [
      {
        ...
        on_finish: function (data) {
          data.correct = jsPsych.pluginAPI.compareKeys(
            jsPsych.timelineVariable("comprehension")[3],
            data.response,
          );
        },
      },
    ...
    conditional_function: function () {
      return expOptions.comprehension;
    },
  };
  ...
  var end = {
    ...
    stimulus: function () {
      ...
      let total_questions = jsPsych.data
        .get()
        .filterCustom(function (data) {
          return Array.isArray(data.comprehension);
        })
        .count();
