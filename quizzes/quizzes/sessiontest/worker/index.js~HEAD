...
const READ_QUEUE = 'sessiontest_quiz_dbread';
const WRITE_QUEUE = 'sessiontest_quiz_dbwrite';
const TASK_QUEUE = 'sessiontest_quiz_taskworker'; // eventually this should be moved to a separate thing
