...
// .js files in root have specific expectations by api/server.js
...
module.exports = (rpc, conn, dbWrite) => { // don't use dbWrite
	const router = new express.Router();

	router.get('/health', (req, res, next) => {
		const params = new RPCParams('health', '');
		return rpc(conn, 'bloodmagic_api_queue', params.getParams())
